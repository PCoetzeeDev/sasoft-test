...
<div class="flex flex-wrap mb-2">
    <div class="w-full px-1 mb-2 md:mb-1 sm:mb-1">
        ...
        <input class="appearance-none block w-full border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500"
               id="txtStreetAddress" type="text" name="street" value="{{ $address->street }}">
    </div>
</div>
...
<div class="flex mb-2">
    <div class="w-1/3 md:w-1/3 sm:w-1/3 px-1 mb-2">
        ...
        <input class="appearance-none block w-full border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500"
               id="txtCity" type="text" name="city" value="{{ $address->city }}">
    </div>
    <div class="w-1/3 px-1 mb-2 md:mb-1 sm:mb-1">
        ...
        <input class="appearance-none block w-full border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500"
               id="txtPostalCode" type="text" name="postal_code" value="{{ $address->postal_code }}">
    </div>
    <div class="w-1/3 px-1 mb-2 md:mb-1 sm:mb-1">
        ...
        <input class="appearance-none block w-full border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500"
               id="txtCountry" type="text" name="country" value="{{ $address->country }}">
    </div>
</div>